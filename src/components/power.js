...
class power extends Component {
   ...
   state = { 
    ...
    render() { 
        ...
        const {usage,usageDaily,loading_usage,loading_usageDaily,energyToday,loading_energyToday,energyThisMonth,loading_energyThisMonth,energy1Month,loading_energy1Month,energy2Months,loading_energy2Months,energy3Months,loading_energy3Months,secsMonth,secsTillNow} = this.state;
        return (  
        <div>
            <Container fluid>
            ...
            <Container fluid>
                ...
                {/* <h1 className={styles.subtitle}>na dnevni ravni</h1> */}
                    <Row noGutters="true">
